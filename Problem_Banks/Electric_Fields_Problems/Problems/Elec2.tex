...
\begin{tikzpicture}
    ...
    \node at (1,-1) {$\rho$};
    \fill[gray,opacity=0.5] (6,0) ellipse (0.5 and 1.25);
    \draw (6,0) ellipse (0.5 and 1.25);
    \draw (6,-1.25) -- (9.5,-1.25);
    \draw (9.5,-1.25) arc (-90:90:0.5 and 1.25);
    \draw [dashed] (9.5,-1.25) arc (90:270:0.5 and -1.25);
    \draw (6,1.25) -- (9.5,1.25);
    % \draw[dashed] (0,2) -- (6,1.25);
    % \draw[dashed] (0,-2) -- (6,-1.25);
